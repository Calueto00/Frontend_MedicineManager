    ...
    return (
        <>
            <div className="bg-white p-2 flex items-center justify-between">
                ...
                <button className="bg-blue-800 text-white rounded-md px-4 py-2">Add Doctor</button>
            </div>
                        ...
                        <tbody>
                            {
                                doctors && doctors?.length > 0 ? (doctors.map((doctor)=>(
                                    <tr key={doctor.id} className="text-base border-b-6 shadow-md bg-white text-center border-slate-100 rounded-md">
                                ...
                                ))) : (<div className="text-slate-400 text-center">No doctors found...</div>)
                            }
                        </tbody>
                    </table>
                </div>
